class Studente:
    ...
    def visualizza_info(self):
        """Restituisce le informazioni dello studente."""
...
studente2 = Studente("Giulia Verdi", 22, "67890")

print(studente1.visualizza_info())
print(studente2.visualizza_info())
print(f"Numero totale di studenti: {Studente.numero_studenti()}")
